	...
	public static void main(String[] args) {
		...
		try {
            ...
            csvPrinter.printRecord(seasonStatObj.getAverageHomeGamesPlayed(),seasonStatObj.getAverageHomeGoalsLeague(),
            		...
            		seasonStatObj.getAverageAwayGoalsLeague(),seasonStatObj.getAverageOfAwayGoalsAverage(),seasonStatObj.getAverageofGoalsConcededByAwayTeams(),
            		seasonStatObj.getAverageOfGoalsConcededByAwayTeamAverage());
